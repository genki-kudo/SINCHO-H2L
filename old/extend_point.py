...
mw_from_vol = json.loads(open(absscriptpath+'/comp_stat_dataset/vol_mw_fitting.json').read())
mw_from_dist = json.loads(open(absscriptpath+'/comp_stat_dataset/dist_passmw_fitting.json').read())
